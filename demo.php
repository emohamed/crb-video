...
<body>
	<div class="shell">
		...
		<?php echo Carbon_Video::create("https://www.youtube.com/watch?v=n4RjJKxsamQ")->set_param('rel', 0)->get_embed_code(); ?>
		...
		<?php
			...
			echo Carbon_Video::create($embed_code)->set_param('controls', 0)->get_embed_code();
		?>
