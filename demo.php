...
<body>
	<div class="shell">
		...
		<?php echo Crb_Video::create("https://www.youtube.com/watch?v=n4RjJKxsamQ")->get_embed_code(640, 480); ?>

		<h3>Accept Youtube URL, produce Flash Embed 640 x 480</h3>
		<?php echo Crb_Video::create("https://www.youtube.com/watch?v=n4RjJKxsamQ")->get_flash_embed_code(640, 480);
		?>

		<h3>Accept Youtube URL, produce embed without related videos</h3>
		<?php echo Crb_Video::create("https://www.youtube.com/watch?v=n4RjJKxsamQ")->set_argument('rel', 0)->get_embed_code(); ?>

		<h3>Accept YouTube shortlink Produce embed code</h3>
		<?php echo Crb_Video::create("http://youtu.be/n4RjJKxsamQ")->get_embed_code(); ?>
		...
		<?php
			...
			echo Crb_Video::create($embed_code)->set_argument('controls', 0)->get_embed_code();
		?>
